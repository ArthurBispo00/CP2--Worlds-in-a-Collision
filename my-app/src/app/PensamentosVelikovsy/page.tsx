  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Uma visão sobre os pensamentos de Immanuel Velikovsky e suas teorias sobre a interconexão entre o cosmos e a história."
        />
      </Head>
      <div style={{ padding: "20px", maxWidth: "800px", margin: "auto" }}>
        <h1 className="text-4xl mb-6">Os Pensamentos de Velikovsky</h1>

        <h2 className="text-3xl mt-8 mb-4">1. Mundos em Colisão: A Teoria de Velikovsky</h2>
        <p className="mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4">2. Eventos Cataclísmicos de Vênus</h2>
        <p className="mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4">3. Comparação com Mitologias Antigas</h2>
        <p className="mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4">4. Desafios Científicos e Controvérsias</h2>
        <p className="mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4">5. Amnésia Coletiva</h2>
        <p className="mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4">6. Controvérsia e Legado</h2>
        <p className="mb-4">
